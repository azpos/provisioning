...
runuser --pty -u azuser -w PYTHONUNBUFFERED,ANSIBLE_CALLBACKS_ENABLED -- ansible-pull -U https://github.com/azpos/provisioning -i "$(hostname --short)," playbooks/common.yml playbooks/control.yml
